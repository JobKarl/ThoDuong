...
public class MyTicketPage extends GeneralPage{
    ...
    //element
    public WebElement getFilterDepartSt(){return Constant.WEBDRIVER.findElement(By.name("FilterDpStation"));}
    public WebElement getFilterArriveSt(){return Constant.WEBDRIVER.findElement(By.name("FilterArStation"));}
    public WebElement getFilterDepartDate(){return Constant.WEBDRIVER.findElement(By.name("FilterDpDate"));}
    public WebElement getFilterStatus(){return Constant.WEBDRIVER.findElement(By.name("FilterStatus"));}
    public WebElement getBtnApplyFilter(){return Constant.WEBDRIVER.findElement(By.xpath("//input[@type='submit']"));}
    ...
    public List<WebElement> getTicket (String departFrom, String arriveAt, String seatType, String departDate,
                                       int amountTicket
            , String status) {
        return Constant.WEBDRIVER.findElements(By.xpath("//tr/td[text()='" + departFrom + "" +
                "']/following-sibling::td[text()='" + arriveAt + "']/following-sibling::td[text()='" + seatType +
                "']/following-sibling::td[text()='" + departDate + "']/following-sibling::td[text()" +
                "='" + status + "']/following-sibling::td[text()='" + amountTicket + "']/following-sibling::td/input[@type" +
                "='button']/../.."));
